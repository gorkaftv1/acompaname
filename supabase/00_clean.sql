...
DROP FUNCTION IF EXISTS public.publish_questionnaire(UUID)          CASCADE;
DROP FUNCTION IF EXISTS public.soft_delete_question(UUID)           CASCADE;
DROP FUNCTION IF EXISTS public.guard_published_immutability()       CASCADE;
DROP FUNCTION IF EXISTS public.is_admin()                           CASCADE;
DROP FUNCTION IF EXISTS public.set_updated_at()                     CASCADE;

-- Resetear usuarios de auth (quitar en producción)
